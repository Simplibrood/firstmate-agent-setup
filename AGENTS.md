...
state/               runtime records and signals; gitignored
  ...
  <id>.pause-resume-nudged  the one declared wait this crewmate has already been sent a resume steer for, and when; bin/fm-pause-resume.sh owns the declaration identity, the once-per-deadline rule, and the cooldown floor
